...
TIMES="10"
 ...
 cdndomain=$(cat /etc/domain/cf-domain 2>/dev/null || cat /etc/xray/flare-domain 2>/dev/null || echo "localhost")
...
echo -e "  ${BIPurple}GET /cdn-cgi/trace HTTP/1.1[crlf]Host: $domain[crlf]Connection:
...
=============================================
Payload WS/WSS
GET /cdn-cgi/trace HTTP/1.1[crlf]Host: your-zero-rate-host[crlf][crlf]CF-RAY / HTTP/1.1[crlf]Host: $domain[crlf]Connection: Upgrade[crlf]User-Agent: [ua][crlf]Upgrade: websocket[crlf][crlf]
...
<code>GET /cdn-cgi/trace HTTP/1.1[crlf]Host: your-zero-rate-host[crlf][crlf]CF-RAY / HTTP/1.1[crlf]Host: $domain[crlf]Connection: Upgrade[crlf]User-Agent: [ua][crlf]Upgrade: websocket[crlf][crlf]</code>
━━━━━━━━━━━━━━━━━━━━━━━━━━━"
